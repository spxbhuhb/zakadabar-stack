 ...
 */
@Serializable
data class LocaleStringDto(
    override var id: RecordId<LocaleStringDto>,
    var name: String,
    var locale: String,
    var value: String,
) : RecordDto<LocaleStringDto> {

    companion object : RecordDtoCompanion<LocaleStringDto>({
        recordType = "locale-string"
    })

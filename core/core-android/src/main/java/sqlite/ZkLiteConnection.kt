...
//    }
    ...
    init {
        ...
        var dbQname: String
        if (url.startsWith(ZkLiteDriver.xerialPrefix)) {
            dbQname = url.substring(ZkLiteDriver.xerialPrefix.length)
        } else {
            ...
            dbQname = url.substring(ZkLiteDriver.sqldroidPrefix.length)
        }

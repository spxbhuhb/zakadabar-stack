...
class SQLDroidPreparedStatement(
    sql: String, sqldroid: SQLDroidConnection,
    ...
    protected var sqldroidConnection: SQLDroidConnection
    protected var rs: SQLDroidResultSet? = null
    ...
    protected var l: ArrayList<Any?>? = ArrayList()
    protected var lBatch = ArrayList<ArrayList<Any?>?>()

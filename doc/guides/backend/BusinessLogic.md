...
BLs extend [EntityBusinessLogicBase](/core/core/src/jvmMain/kotlin/zakadabar/stack/backend/business/EntityBusinessLogicBase.kt).
...
- extend [ActionBusinessLogicBase](/core/core/src/jvmMain/kotlin/zakadabar/stack/backend/business/ActionBusinessLogicBase.kt)
- set an authorizer
...
- extend [QueryBusinessLogicBase](/core/core/src/jvmMain/kotlin/zakadabar/stack/backend/business/QueryBusinessLogicBase.kt)
- set an authorizer
- implement the `execute` function
...
[KtorRouter](/core/core/src/jvmMain/kotlin/zakadabar/stack/backend/ktor/KtorRouter.kt) has an `apiCacheControl` function
...
* globally, by extending [Server](/core/core/src/jvmMain/kotlin/zakadabar/stack/backend/Server.kt)

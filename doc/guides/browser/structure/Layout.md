...
* Layout classes extend [ZkAppLayout](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/application/ZkAppLayout.kt).
* There is one active layout at one time, others are in the DOM but hidden.
* [ZkAppRouting](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/application/ZkAppRouting.kt) handles layout changes
...
* [ZkDefaultLayout](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/builtin/layout/ZkDefaultLayout.kt)
...
implementation: [ZkAppTitleBar](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/builtin/titlebar/ZkTitleBar.kt)

Pages, tables and forms use `application.title` to set the title and context elements of the title bar.

All high level elements (ZkPage, ZkArgPage, ZkForm, ZkTable) implement the [ZkAppTitleProvider](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/builtin/titlebar/ZkAppTitleProvider.kt)
...
Some may override this function to add actions. Check [ZkTable](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/builtin/table/ZkTable.kt) for example.

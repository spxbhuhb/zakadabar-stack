...
* Use [ZkIcon](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/builtin/icon/ZkIcon.kt) to display a simple icon.
* Get built-in icons from [ZkIcons](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/resources/ZkIcons.kt).
* Use a [button](./Buttons.md) instead to display an icon with containing box, fill, etc.
* Extend [ZkIconStyles](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/builtin/button/zkButtonStyles.kt) to override
...
Constructor parameters of [ZkIcon](/core/core-core/src/jsMain/kotlin/zakadabar/stack/frontend/builtin/icon/ZkIcon.kt):
